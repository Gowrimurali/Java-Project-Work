...
public class BubbleSortTest {
    ...
    @Test
    @DisplayName("Choice one is bubblesort")
    void choiceOneIsBubblesort() {

        assertEquals("BUBBLESORT", AlgorithmNames.values()[algorithmNumber-1].name());
    }
    
    @Test
    @DisplayName("Sort with bubble sort")
    void sortWithBubbleSort() {
        int arrayLength = 20;
