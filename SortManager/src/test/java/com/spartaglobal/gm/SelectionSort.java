...
public class SelectionSort {
    ...
    private int algorithmNumber = 3;
    Sorter sorter = SortObjectGenerator.getSortAlgorithmObject(algorithmNumber);

    @Test
    @DisplayName("Choice three is Selection Sort")
    void choiceOneIsInsertionSort() {
        Assertions.assertEquals("SELECTIONSORT", AlgorithmNames.values()[algorithmNumber-1].name());
    }

    @Test
    @DisplayName("Sort with Selection Sort")
