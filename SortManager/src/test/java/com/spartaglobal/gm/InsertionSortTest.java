...
public class InsertionSortTest {
    ...
    private int algorithmNumber = 2;
    Sorter sorter = SortObjectGenerator.getSortAlgorithmObject(algorithmNumber);

    @Test
    @DisplayName("Choice two is Insertion Sort")
    void choiceOneIsInsertionSort() {
        Assertions.assertEquals("INSERTIONSORT", AlgorithmNames.values()[algorithmNumber-1].name());
    }

    @Test
    @DisplayName("Sort with Insertion Sort")
