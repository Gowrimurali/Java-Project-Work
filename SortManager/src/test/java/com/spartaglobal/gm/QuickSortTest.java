...
public class QuickSortTest {
    ...
    private int algorithmNumber = 5;
    Sorter sorter = SortObjectGenerator.getSortAlgorithmObject(algorithmNumber);

    @Test
    @DisplayName("Choice five is Quick Sort")
    void choiceOneIsInsertionSort() {
        Assertions.assertEquals("QUICKSORT", AlgorithmNames.values()[algorithmNumber-1].name());
    }


    @Test
    @DisplayName("Sort with Quick Sort")
